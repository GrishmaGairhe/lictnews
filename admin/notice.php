...
<a href="createnotice.php" class="bg-blue-700 text-white px-3 py-2 rounded-lg">Add Notice</a>
</div>

<table class="w-full">
<tr class="bg-gray-300">
    <th class="border border-gray-600 p-2">Order</th>
    <th class="border border-gray-600 p-2">Title</th>
    <th class="border border-gray-600 p-2">Notice Date</th>
