...
<body>
   <div class="flex">
      <div class="w-56 bg-gray-100 shadow h-screen">
        <img src="https://nepalserofero.com/images/logo/logo.png" alt="" class="h-12 my-10">
        <nav>
          ...
          <a href="" class="font-bold text-xl pl-2 border-b block border-gray-200 py-3 hover:bg-gray-200">Categories</a>
